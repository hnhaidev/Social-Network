...
function Settings({ newMessagePopup }) {
  ...
  return (
    <>
      {success && (
        <>
          <Message success icon="check circle" header="Cập nhật thành công !" />
          <Divider hidden />
        </>
      )}
      ...
      <List size="huge" animated>
        <List.Item>
          <List.Icon name="user secret" size="small" verticalAlign="middle" />
          <List.Content>
            <List.Header
        ...
        <List.Item>
          ...
          <List.Content>
            <List.Header
              ...
              as="a"
              content="Hiển thị cửa sổ bật lên tin nhắn mới ?"
              style={{ fontSize: "0.8em" }}
            />
          </List.Content>

          <div style={{ marginTop: "10px", fontSize: "0.7em" }}>
            Hiển thị cửa sổ bật lên tin nhắn mới hay không.
            <br />
            <br />
            <Checkbox
